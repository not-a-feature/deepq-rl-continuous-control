"""
Adapted from "Continuous control with deep reinforcement learning"
b yTimothy P Lillicrap, Jonathan J Hunt, Alexander Pritzel, Nicolas Heess,
        ...
        for episode in range(1, self.EPISODES + 1):
            ...
            for t in range(self.MAX_STEPS):
                ...
                if len(replay_buffer.buffer) > self.BATCH_SIZE:
                    buffer = replay_buffer.sample(self.BATCH_SIZE)
                    ...
                    target_critic_val = target_critic(next_states, target_actions)
                    y = rewards + self.GAMMA * target_critic_val * (1 - dones)
